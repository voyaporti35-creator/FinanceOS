...
export const useTransactionStore = create<TransactionStoreState>((set) => ({
  ...
  createTransaction: async (transaction) => {
    try {
      ...
      set({
        error: error instanceof Error ? error.message : "No se pudo crear la transacción",
      });
    }
  },
  ...
  updateTransaction: async (transaction) => {
    try {
      ...
      set({
        error: error instanceof Error ? error.message : "No se pudo actualizar la transacción",
      });
    }
  },
  ...
  deleteTransaction: async (id) => {
    try {
      ...
      set({
        error: error instanceof Error ? error.message : "No se pudo eliminar la transacción",
      });
    }
  },
}));
